...
impl Edge {
    ...
    pub fn ranges(&self) -> std::slice::Iter<'_, Range> {
        self.ranges.iter()
    }
    ...
    #[inline]
    pub fn push(&mut self, range: impl Into<Range>) {
    ...
    pub fn merge_range(&mut self, other: Range) {
...
impl std::convert::From<Range> for Edge {
